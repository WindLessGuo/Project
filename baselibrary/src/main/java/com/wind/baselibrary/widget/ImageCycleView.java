package com.wind.baselibrary.widget;
...
public class ImageCycleView extends LinearLayout {
    ...
    public void setImageResources(ArrayList<String> imageUrlList, ImageCycleViewListener imageCycleViewListener) {
        ...
        for (int i = 0; i < imageCount; i++) {
            ...
            // int imageParams = (int) mContext.getResources().getDimension(R.dimen.y10);
            // int imagePadding = (int) mContext.getResources().getDimension(R.dimen.x18);
            mImageView.setLayoutParams(new LayoutParams(imageParams, imageParams));
            mImageView.setPadding(imagePadding, imagePadding, imagePadding, imagePadding);
//            ((MarginLayoutParams)mImageView.getLayoutParams())
//                    .setMargins((int) mContext.getResources().getDimension(R.dimen.x18), 0, 0, 0);
    ...
    private class ImageCycleAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            // 设置图片点击监听
            imageView.setOnClickListener(v -> mImageCycleViewListener.onImageClick(position, v));
